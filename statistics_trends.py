...
def bargraph_1():
    ...
    C = ['grey', 'orange', 'red', 'green', 'steelblue', 'yellow', 'violet','khaki']
    ...
    CH4_df.plot(kind='bar', figsize=(10, 7), width=0.5,
...
def bargraph_2():
    ...
    meth_df = CH4_df_meth[CH4_df_meth['Country Name'].isin(countries)][['Country Name', '2014 [YR2014]', '2018 [YR2018]']].copy()
